      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Restraunt Registration</span></p>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
						<form action="serverlogin.php" method="POST" class="billing-form">
	          	...
	          	<div class="row align-items-end">
	                ...
	                <div class="form-group">
	                  ...
	                  <input type="text" name="phone" class="form-control" placeholder="" pattern="[6789][0-9]{9}">
	                </div>
	              </div>
	              <div class="col-md-6">
	                <div class="form-group">
	                	<label for="emailaddress">Email Address</label>
	                  <input type="text" name="email" type="email" id="email" class="form-control" placeholder="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
	                </div>
                </div> 
                <div class="col-md-6">
	                <div class="form-group">
