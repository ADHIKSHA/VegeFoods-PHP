      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span class="mr-2"><a href="index.php">Product</a></span> <span>Product Add</span></p>
    ...
    <section class="ftco-section">
    	<div class="container">
            ...
            <form action="save.php" method="POST">
              CHOOSE AN IMAGE OF THE DISH:-
    				<input type="file" name="img" accept="image/gif,image/jpeg">
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
            
    				<h3>NAME:- <input type="text" name="ndish"></h3>
    				
    				<p class="price"><span>PRICE:- <input type="text" name="dprice"></span></p>
	                  ...
	                  <select name="category" id="category" class="form-control">
	                    ...
	                    <option value="snacks">Snacks and siders</option>
          	...
          	<p><input type="submit" name="adddish" value="Add Dish" class="btn btn-black py-3 px-5"></p>
    			</div>
    		</div></form>
    	</div>
    </section>
