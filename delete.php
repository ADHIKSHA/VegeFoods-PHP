...
if(isset($_POST['deleteit'])){
  foreach ($_POST as $key => $value) {
    # code...
    $q="DELETE FROM menu WHERE dishid='$key'";
    mysqli_query($db, $q);
  }
}
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Delete</span></p>
...
<table class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
<?php $dishid=$row[0]; array_push($dishids,$dishid);?> 
        <td><input type="checkbox" name="<?php echo $dishid;?>"></td>
